package com.remita.systemspecs.stateandlocations.exceptions;
...
public class ExtendedConstants {
    ...
    public enum ResponseCode {
        ...
        UNKNOWN_PHONE_NUMBER("108", "Phone Number does not exist"),
        INVALID_REQUEST_MONEY("109", "Can not request money from the same phone number"),
        RECORD_NOT_FOUND("011", "Record not found"),
        ACCOUNT_NAME_NOT_FOUND("110", "Account name is not found"),
        INVALID_TRANSFER("111", "Invalid Transfer"),
        KYC_UPGRADE_DENIED("112", "Cannot Upgrade to KycLevel"),
        INVALID_KYC_UPGRADE_LEVEL("99", "Invalid Kyc Upgrade Level"),
        ENTITY_NOT_FOUND("044", "ENTITY NOT FOUND"),
        BAD_REQUEST("041","BAD REQUEST");
